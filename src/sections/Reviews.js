  ...
  return (
    <div className="reviews" id='reviews'>
      ...
      <div className="reviews-inner">
        ...
        <ReviewItem name='Emily Turner' title='Remarkable!' desc="The accuracy of this trading indicator is outstanding. It's been a game-changer for my investment strategy, and I've seen great returns. Definitely a must-have for serious traders."/>
      </div>
    </div>
  )
}